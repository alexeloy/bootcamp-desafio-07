...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const transactionsFormated = transactions.map((e: Transaction) => {
        return {
          ...e,
          formattedValue: formatValue(e.value),
          formattedDate: new Date(e.created_at).toLocaleDateString('pt-br'),
        }
      });
